...
#include "../../../AdvancedSessions/Source/AdvancedSessions/Classes/OnlineSubSystemHeader.h"
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_SteamAvatarSize(SteamAvatarSize_StaticEnum, TEXT("/Script/AdvancedSteamSessions"), TEXT("SteamAvatarSize"), false, nullptr, nullptr);
	...
	{
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamFriendsLibrary::StaticClass(), "CreateSteamIDFromString",(Native)&UAdvancedSteamFriendsLibrary::execCreateSteamIDFromString);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamFriendsLibrary::StaticClass(), "GetFriendSteamLevel",(Native)&UAdvancedSteamFriendsLibrary::execGetFriendSteamLevel);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamFriendsLibrary::StaticClass(), "GetSteamFriendAvatar",(Native)&UAdvancedSteamFriendsLibrary::execGetSteamFriendAvatar);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamFriendsLibrary::StaticClass(), "GetSteamPersonaName",(Native)&UAdvancedSteamFriendsLibrary::execGetSteamPersonaName);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamFriendsLibrary::StaticClass(), "RequestSteamFriendInfo",(Native)&UAdvancedSteamFriendsLibrary::execRequestSteamFriendInfo);
	}
	IMPLEMENT_CLASS(UAdvancedSteamFriendsLibrary, 574297918);
static class UEnum* FBPWorkshopFileType_StaticEnum()
{
	extern ADVANCEDSTEAMSESSIONS_API class UPackage* Z_Construct_UPackage__Script_AdvancedSteamSessions();
	static class UEnum* Singleton = NULL;
	if (!Singleton)
...
static class UEnum* FBPSteamResult_StaticEnum()
{
	extern ADVANCEDSTEAMSESSIONS_API class UPackage* Z_Construct_UPackage__Script_AdvancedSteamSessions();
	static class UEnum* Singleton = NULL;
	if (!Singleton)
...
static struct FScriptStruct_AdvancedSteamSessions_StaticRegisterNativesFBPSteamWorkshopID
{
	...
	{
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamWorkshopLibrary::StaticClass(), "GetNumSubscribedWorkshopItems",(Native)&UAdvancedSteamWorkshopLibrary::execGetNumSubscribedWorkshopItems);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedSteamWorkshopLibrary::StaticClass(), "GetSubscribedWorkshopItems",(Native)&UAdvancedSteamWorkshopLibrary::execGetSubscribedWorkshopItems);
	}
	IMPLEMENT_CLASS(UAdvancedSteamWorkshopLibrary, 1690005767);
	void USteamWSRequestUGCDetailsCallbackProxy::StaticRegisterNativesUSteamWSRequestUGCDetailsCallbackProxy()
	{
		FNativeFunctionRegistrar::RegisterFunction(USteamWSRequestUGCDetailsCallbackProxy::StaticClass(), "GetWorkshopItemDetails",(Native)&USteamWSRequestUGCDetailsCallbackProxy::execGetWorkshopItemDetails);
	}
	IMPLEMENT_CLASS(USteamWSRequestUGCDetailsCallbackProxy, 1703476477);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_AdvancedSteamSessions_SteamAvatarSize()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("SteamAvatarSize::SteamAvatar_Small")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("SteamAvatarSize::SteamAvatar_Medium")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("SteamAvatarSize::SteamAvatar_Large")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("SteamAvatarSize::SteamAvatar_MAX")), 4));
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSteamSessions_SteamAvatarSize_CRC() { return 800128654U; }
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAdvancedSteamFriendsLibrary(Z_Construct_UClass_UAdvancedSteamFriendsLibrary, &UAdvancedSteamFriendsLibrary::StaticClass, TEXT("UAdvancedSteamFriendsLibrary"), false, nullptr, nullptr, nullptr);
	...
	UEnum* Z_Construct_UEnum_AdvancedSteamSessions_FBPWorkshopFileType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeCommunity")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeMicrotransaction")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeCollection")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeArt")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeVideo")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeScreenshot")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeGame")), 6));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeSoftware")), 7));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeConcept")), 8));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeWebGuide")), 9));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeIntegratedGuide")), 10));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeMerch")), 11));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeControllerBinding")), 12));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeSteamworksAccessInvite")), 13));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeSteamVideo")), 14));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_EWorkshopFileTypeMax")), 15));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPWorkshopFileType::k_MAX")), 16));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSteamSessions_FBPWorkshopFileType_CRC() { return 696915418U; }
	UEnum* Z_Construct_UEnum_AdvancedSteamSessions_FBPSteamResult()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultOK")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultFail")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultNoConnection")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidPassword")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultLoggedInElsewhere")), 6));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidProtocolVer")), 7));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidParam")), 8));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultFileNotFound")), 9));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultBusy")), 10));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidState")), 11));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidName")), 12));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidEmail")), 13));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultDuplicateName")), 14));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccessDenied")), 15));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultTimeout")), 16));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultBanned")), 17));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountNotFound")), 18));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidSteamID")), 19));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultServiceUnavailable")), 20));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultNotLoggedOn")), 21));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultPending")), 22));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultEncryptionFailure")), 23));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInsufficientPrivilege")), 24));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultLimitExceeded")), 25));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRevoked")), 26));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultExpired")), 27));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAlreadyRedeemed")), 28));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultDuplicateRequest")), 29));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAlreadyOwned")), 30));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIPNotFound")), 31));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultPersistFailed")), 32));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultLockingFailed")), 33));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultLogonSessionReplaced")), 34));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultConnectFailed")), 35));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultHandshakeFailed")), 36));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIOFailure")), 37));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRemoteDisconnect")), 38));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultShoppingCartNotFound")), 39));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultBlocked")), 40));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIgnored")), 41));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultNoMatch")), 42));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountDisabled")), 43));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultServiceReadOnly")), 44));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountNotFeatured")), 45));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAdministratorOK")), 46));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultContentVersion")), 47));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultTryAnotherCM")), 48));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultPasswordRequiredToKickSession")), 49));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAlreadyLoggedInElsewhere")), 50));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultSuspended")), 51));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultCancelled")), 52));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultDataCorruption")), 53));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultDiskFull")), 54));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRemoteCallFailed")), 55));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultPasswordUnset")), 56));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultExternalAccountUnlinked")), 57));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultPSNTicketInvalid")), 58));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultExternalAccountAlreadyLinked")), 59));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRemoteFileConflict")), 60));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIllegalPassword")), 61));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultSameAsPreviousValue")), 62));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLogonDenied")), 63));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultCannotUseOldPassword")), 64));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidLoginAuthCode")), 65));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLogonDeniedNoMail")), 66));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultHardwareNotCapableOfIPT")), 67));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIPTInitError")), 68));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultParentalControlRestricted")), 69));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultFacebookQueryError")), 70));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultExpiredLoginAuthCode")), 71));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultIPLoginRestrictionFailed")), 72));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLockedDown")), 73));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLogonDeniedVerifiedEmailRequired")), 74));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultNoMatchingURL")), 75));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultBadResponse")), 76));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRequirePasswordReEntry")), 77));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultValueOutOfRange")), 78));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultUnexpectedError")), 79));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultDisabled")), 80));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultInvalidCEGSubmission")), 81));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRestrictedDevice")), 82));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRegionLocked")), 83));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultRateLimitExceeded")), 84));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLoginDeniedNeedTwoFactor")), 85));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultItemDeleted")), 86));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountLoginDeniedThrottle")), 87));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultTwoFactorCodeMismatch")), 88));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultTwoFactorActivationCodeMismatch")), 89));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultAccountAssociatedToMultiplePartners")), 90));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_EResultNotModified")), 91));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FBPSteamResult::k_MAX")), 92));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AdvancedSteamSessions_FBPSteamResult_CRC() { return 3013371400U; }
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAdvancedSteamWorkshopLibrary(Z_Construct_UClass_UAdvancedSteamWorkshopLibrary, &UAdvancedSteamWorkshopLibrary::StaticClass, TEXT("UAdvancedSteamWorkshopLibrary"), false, nullptr, nullptr, nullptr);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_USteamWSRequestUGCDetailsCallbackProxy(Z_Construct_UClass_USteamWSRequestUGCDetailsCallbackProxy, &USteamWSRequestUGCDetailsCallbackProxy::StaticClass, TEXT("USteamWSRequestUGCDetailsCallbackProxy"), false, nullptr, nullptr, nullptr);
	...
	UPackage* Z_Construct_UPackage__Script_AdvancedSteamSessions()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), NULL, FName(TEXT("/Script/AdvancedSteamSessions")), false, false));
